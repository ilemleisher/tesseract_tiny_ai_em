...
name = 'data_cont_I4_D20250102_T224816_F0001.npz'
...
with np.load(filepath) as d:
    ...
    # i = 140
        ...
        # plt.close(fig)
        fig.savefig("/home/ilemleisher/plots/plot_no_radius_"+str(name[:-4])+"_chunk_"+str(i)+".png")
        plt.close(fig)