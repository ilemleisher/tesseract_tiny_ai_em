...
def spectral_peak_noise(t, a, f):
    return (a+np.random.normal(0, 1))*np.sin(f*t)
...
if __name__ == '__main__':
        ...
        with h5py.File(filepath, "r") as data:
            ...
            for event in events:
                ...
                if np.random.random() < 0.01:
                    ...
                    waveform_data = spectral_peak_noise(time_data, 5, 1500) + waveform_data
    ...
    # for i in range(len(freqs_list[:100])):
    ...
    #     fig.savefig("/home/ilemleisher/plots/artificial_noise/plot_noise_"+str(filename[:-4])+"_chunk_"+str(i)+".png")
    #     plt.close(fig)
